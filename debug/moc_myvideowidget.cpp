...
const QMetaObject MyVideoWidget::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_MyVideoWidget.data,
...
void *MyVideoWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QOpenGLFunctions"))
        return static_cast< QOpenGLFunctions*>(const_cast< MyVideoWidget*>(this));
    if (!strcmp(_clname, "VideoBase"))
        return static_cast< VideoBase*>(const_cast< MyVideoWidget*>(this));
